...
class UpdateHouseholdRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'toilet_type' => ['nullable', 'integer', Rule::in([1, 2, 3, 4])],
            'water_source' => ['nullable', 'integer', Rule::in([1, 2])],
            'food_production_activity' => ['nullable', 'string', Rule::in(['VG', 'FT', 'PL', 'FP', 'NA'])],
            ...
            'members.*.id' => ['nullable', 'integer', 'exists:household_members,id'],
